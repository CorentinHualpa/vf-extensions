export const FormExtension = {
  ...
  render: ({ trace, element }) => {
    ...
    container.innerHTML = `
      <style>
        .form-card {
          /* Pour occuper toute la largeur du widget, avec une marge */
          width: calc(100% - 40px);
          margin: 20px auto;
    ...
    // 6) Écouteur de soumission du formulaire
