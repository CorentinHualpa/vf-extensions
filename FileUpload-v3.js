  ...
  render: ({ trace, element }) => {
    try {
      ...
      const T = isDark ? {
        ...
        zoneBg: 'rgba(255,255,255,0.03)',
        zoneBorder: 'rgba(255,255,255,0.12)',
        zoneHoverBg: 'rgba(255,255,255,0.06)',
        zoneDragBg: `rgba(${pc.r},${pc.g},${pc.b},0.08)`,
        zoneDragBorder: primaryColor,
        fileBg: 'rgba(255,255,255,0.05)',
        fileHoverBg: 'rgba(255,255,255,0.08)',
        ...
        counterBg: 'rgba(255,255,255,0.06)',
      } : {
        bg: '#FFFFFF',
        cardBg: '#FAFAFA',
